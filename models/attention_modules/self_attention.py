...
from models.attention_modules.gam_attention import GAM_Attention
...
class AttentionModule(nn.Module):
    def __init__(self, feature_size, text_feature_size, num_heads, *args, **kwargs):
        ...
        # 初始化GAM注意力模块
        self.gam_attention = GAM_Attention(in_channels=feature_size, out_channels=feature_size)
    ...
    def forward(self, x, t, return_map=False, *args, **kwargs):
        ...
        # 添加GAM注意力
        gam_output = self.gam_attention(x)
        x = x + gam_output
